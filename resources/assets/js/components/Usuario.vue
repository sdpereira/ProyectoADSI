                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" @click="eliminarPersona(persona)"><i class="icon-trash"></i>
                                        </button>&nbsp;
                                        <template v-if="persona.condicion">
                                            <button type="button" class="btn btn-info btn-sm" @click="desactivarUsuario(persona.id)">
                ...
                <div class="modal-dialog modal-danger" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="eliminarPersona" class="btn btn-danger">
                                Eliminar
                            </button>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        Swal.fire({
            ...
            activarUsuario(id){
               swal({
                title: '¿Está seguro de acivar este usuario?',
                type: 'warning',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar',
